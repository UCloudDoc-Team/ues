...
在 OpenSearch 集群中可以监控统计很多信息，其中最重要的就是：**集群健康(Cluster Health)**。它的
...
在输出内容的开头，我们可以看到集群名称和我们的第一个节点：

    {
      ...
      "cluster_name" : "opensearch-xxxx",
      "nodes" : {
        "1WiZNqVcSgSGMaBcMffM2Q" : {
          "timestamp" : 1774862042657,
          "name" : "opensearch-1oc86mhqc3zk-02",
          "transport_address" : "10.60.38.100:9300",
          "host" : "10.60.38.100",
          "ip" : "10.60.38.100:9300",
          "roles" : [
            "cluster_manager",
            "data",
            "ingest",
...
``` 
        "indexing" : {
          "index_total" : 86232865,
          "index_time_in_millis" : 1881513,
          "index_current" : 0,
          "index_failed" : 0,
          "delete_total" : 1,
          ...
          "max_last_index_request_timestamp" : 1774862704844
        },
        "get" : {
          "total" : 15,
          "getTime" : "14ms",
        ...
        "search" : {
          "open_contexts" : 0,
          "query_total" : 180545,
          "query_time_in_millis" : 1141643,
          "query_current" : 0,
          "query_failed" : 0,
          "concurrent_query_total" : 7400,
          "concurrent_query_time_in_millis" : 56012,
          "concurrent_query_current" : 0,
          "concurrent_avg_slice_count" : 2.0,
          "startree_query_total" : 0,
          "startree_query_time_in_millis" : 0,
          "startree_query_current" : 0,
          "startree_query_failed" : 0,
          "fetch_total" : 138810,
          "fetch_time_in_millis" : 29567,
          "fetch_current" : 0,
          "scroll_total" : 4800,
          "scroll_time_in_millis" : 1832579,
          "scroll_current" : 0,
          "point_in_time_total" : 1,
          "point_in_time_time_in_millis" : 152,
          "point_in_time_current" : 0,
          "suggest_total" : 0,
          "suggest_time_in_millis" : 0,
          "suggest_current" : 0,
          "search_idle_reactivate_count_total" : 2,
          "request" : {
            "took" : {
              "time_in_millis" : 272298,
              "current" : 146,
              "total" : 7496
            },
            "dfs_pre_query" : {
        ...
        "merges" : {
          ...
          "total" : 120,
          "total_time_in_millis" : 486833,
          "total_docs" : 126358412,
          "total_size_in_bytes" : 11078148153,
          "total_stopped_time_in_millis" : 0,
          "total_throttled_time_in_millis" : 156149,
          "total_auto_throttle_in_bytes" : 749585830,
...
``` 
        ...
        "segments": {
          ...
          "index_writer_memory_in_bytes": 2016064,
          "version_map_memory_in_bytes": 57226,
          "fixed_bit_set_memory_in_bytes": 0,
          "max_unsafe_auto_id_timestamp": 1774529961156,
        ...
```
...
部分描述了整个操作系统，而 Process 部分只显示 OpenSearch 的 JVM 进程使用的资源情况。
...
\`jvm\` 部分包括了运行 OpenSearch 的 JVM 进程一些很关键的信息。最重要的，它包括了垃圾回收的细节，这对你的
OpenSearch 集群的稳定性有着重大影响。

``` 
      "jvm": {
        "timestamp": 1774864138823,
        "uptime_in_millis": 526249503,
        "mem": {
          "heap_used_in_bytes": 3318118616,
          "heap_used_percent": 38,
          "heap_committed_in_bytes": 8589934592,
          "heap_max_in_bytes": 8589934592,
          "non_heap_used_in_bytes": 294198776,
...
``` 
        "index_searcher": {
          ...
          "largest": 8,
          "completed": 3402,
          "total_wait_time_in_nanos": 3069070339
        },
```
...
显然，OpenSearch 在磁盘空间满的时候很难运行——所以请确保不会这样。
...
``` 
      "transport" : {
        ...
        "rx_count" : 2578769,
        "rx_size_in_bytes" : 30559313239,
        "tx_count" : 2578768,
        "tx_size_in_bytes" : 29841885979
      },
      "http" : {
        "current_open" : 3,
        "total_opened" : 349
...
端口）以及任意传输客户端或者节点客户端的连接。如果看到这里有很多连接数不要担心；OpenSearch
在节点之间维护了大量的连接。
...
``` 
      "breakers": {
        ...
        "fielddata": {
          ...
          "limit_size": "3.1gb",
          "estimated_size_in_bytes": 4008,
          "estimated_size": "3.9kb",
          "overhead": 1.03,
          "tripped": 0
        },
```
...
OpenSearch 里很多设置都是动态的，可以通过 API 修改。需要强制重启节点（或者集群）的配置修改都要极力避免。
...
OpenSearch 会输出很多日志，默认的日志记录等级是 INFO 。它提供了适度的信息，但是又设计好了不至于让你的日志太过庞大。
